            ...
            <div className="bg-muted relative hidden h-full flex-col p-10 text-white lg:flex dark:border-r">
                ...
                <div className="relative z-20 mt-auto">
                    <blockquote className="space-y-2">
                        <p className="text-lg">&ldquo;For I know the plans I have for you, declares the Lord, plans for welfare and not for evil, to give you a future and a hope.&rdquo;</p>
                        <footer className="text-sm text-neutral-300">Jeremiah 29:11</footer>
                    </blockquote>
                </div>
            </div>
